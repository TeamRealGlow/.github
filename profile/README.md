...
### 프론트 웹
- Ajax 기반의 비동기 통신<br>Ajax를 활용한 비동기 호출을 통해 CSR(Client-Side Rendering) 방식의 데이터 렌더링을 구현. 서버 요청 시 페이지 리로드 없이 필요한 데이터만 갱신하여 사용자   경험(UX)을 향상시킴.
